...
import org.openelisglobal.reports.action.implementation.reportBeans.CSVPeriodByDateColumnBuilder;
 ...
 * @since April 15, 2025
 */
public class ExportPeriodByDateReport extends CSVSampleExportReport implements IReportParameterSetter {

    @Override
    protected String reportFileName() {
        return "ExportPeriodByDateReport";
    }
    ...
    /**
     * @see IReportCreator#initializeReport(org.openelisglobal.common.action.BaseActionForm)
     */
    @Override
    ...
    private void createReportItems() {
        try {
            ...
            csvColumnBuilder = new CSVPeriodByDateColumnBuilder(dateRange);
