...
function ChangePassword() {
  const intl = useIntl();
  const { notificationVisible, addNotification, setNotificationVisible } = useContext(NotificationContext);
              ...
              <Formik
                ...
                validationSchema={Yup.object().shape({
                  ...
                  newPassword: Yup.string().required()
                    ...
                    .matches(/^(?=.*[*$#!])(?=.*[A-Z])[A-Za-z0-9*$#!]{7,}$/,"Password must contain at least one special character")
                    .test(
                      "not-same-as-old",
                ...
                <Form onSubmit={formik.handleSubmit} onChange={formik.handleChange}>
                  <Stack gap={5}>
                    ...
                    <PasswordInput
                      ...
                      required={true}
                      onBlur={formik.handleBlur}
                      invalid={formik.touched.confirmPassword && formik.values.newPassword !== formik.values.confirmPassword}
                    />
